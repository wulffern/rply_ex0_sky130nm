...
This is a tutorial from 2024, as such, it's not up to date. I would recommend
you look at [Sky130nm tutorial](https://analogicus.com/aic2026/sky130nm_tutorial)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/go02Z-_3x3s?si=fDw2_69DGctVozgG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
Follow the description at [The Tools](https://analogicus.com/aic2026/the_tools)

Even if you have all the open source tools installed, you do need to install `cicsim` and
`cicconf` (Unless you just did while reading the Getting Started link)
...
```
 ...
 If you get wierd results, then check the
 port order in the `tran.spi` compared to the `../work/xsch/RPLY_EX0.spice`
 file. I've seen different versions of Xschem netlist the schematic differently. 
...
<iframe width="400" height="300" src="https://www.youtube.com/embed/2iuqUWrDDaA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
