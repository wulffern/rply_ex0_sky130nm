...
For the rest of the tutorial, I'll assume you'll use `lpro`
...
[aicex](https://wulffern.github.io/aicex/started). It includes this tutorial
...
cicsim is a python toolset that I use to wrap around ngpisce so I don't have to modify the SPICE file for every temperature and corner.
...
Open  [https://github.com/wulffern/rply_ex0_sky130nm/sim/RPLY_BIAS/result/tran_Sch_typical.html]([sim/RPLY_EX0/result/tran_Sch_typical.html])
